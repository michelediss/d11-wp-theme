...
function d11_export_block_registry_json(?string $outputPath = null): string
{
    ...
    if (! function_exists('d11_get_block_catalog')) {
        require_once d11_block_availability_utility_theme_root() . '/inc/block-availability/runtime.php';
    }
    ...
    $payload = [
        'source' => [
            ...
            'script' => 'inc/block-availability/utility/export-block-registry.php',
            'theme_bootstrap' => 'inc/block-availability/bootstrap.php',
            'block_runtime' => 'inc/block-availability/runtime.php',
